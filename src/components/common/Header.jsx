...
const Header = () => {
  ...
  return (
    <>
      <div className={`min-h-screen ff-lato flex items-center justify-center ${path === "/" ? "bg-header rounded-b-[30px]" : "bg-[#01A4FFBD]"}`}>
        <div className="container">
          ...
          <form className={`flex items-center justify-center gap-3 ${path === '/' ? "" : "hidden"}`}>
